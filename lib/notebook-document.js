...
class NotebookDocument {
   ...
   */
  updateModifiedState() {
    this.setModified(!this.matchesSavedContent());
  }

  _markCurrentStateSaved() {
    this.savedHistoryStateId = this.currentHistoryStateId;
    this.savedRuntimeRevision = this.runtimeRevision;
    this.updateModifiedState();
  }
  ...
  serializeState() {
    return {
      ...
      notebookData: !this.filePath || this.isModified() ? this.toJSON() : null,
