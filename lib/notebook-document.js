...
class NotebookDocument {
  ...
  _scheduleFileChangeHandling() {
    if (this._isSaving || this._fileOperationDepth || this.disposables.disposed) return;
  ...
  async _handleFileChange() {
    if (this._isSaving || this._fileOperationDepth || this.disposables.disposed || !this.file)
      return;
