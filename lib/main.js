  ...
  activate(state = {}) {
    ...
    this.disposables.add(
      lumine.commands.add(".jupyter-notebook-container", {
        ...
        // the same path the old jupyter-repl:run-cell dispatches took.
        ...
        "jupyter-view:scroll-up": {
          ...
          didDispatch: () => delegateToNotebook(this, "scrollUp", true),
        },
        "jupyter-view:scroll-down": {
          description: "Scroll the notebook down by one page.",
          didDispatch: () => delegateToNotebook(this, "scrollDown", true),
        },
      }),
    );
