...
class NotebookScrollmap {
  ...
  scheduleUpdate() {
    ...
    this.frameWindow = this.editor?.getElement?.().ownerDocument.defaultView;
  ...
  insertScrollmap() {
    ...
    const domDocument = notebookElement.ownerDocument;
    if (!this.scrollmap || this.scrollmapDocument !== domDocument) {
      this.scrollmap?.destroy();
      this.resizeObserver?.disconnect();
      this.observedContainer = null;
      this.scrollmap = new this.Simplemap(domDocument);
      this.scrollmapDocument = domDocument;
      this.resizeObserver = new domDocument.defaultView.ResizeObserver(() => this.scheduleUpdate());
